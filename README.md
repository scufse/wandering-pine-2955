...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/wandering-pine-2955
```

A live public deployment of this template is available at [https://wandering-pine-2955.templates.workers.dev](https://wandering-pine-2955.templates.workers.dev)
